...
function Dog() {
	...
	function init() {
		...
		self.hair = createBox(105, 20 * self.scl_y, 65, self.hairColor, 0, 50, 0);
		self.torso = createBox(150, 190 * self.scl_y, 500, self.shirtColor, 0, 100, 0);
		//self.leftLowerArm = createLimb(20, 120, 30, self.skinColor, 0, -170, 0);
		//self.leftArm = createLimb(30, 140, 40, self.skinColor, -100, 190, -10);
		//self.rightLowerArm = createLimb(20, 120, 30, self.skinColor, 0, -170, 0);
		//self.rightArm = createLimb(30, 140, 40, self.skinColor, 100, 190, -10);
		self.leftLowerLeg = createLimb(40, 200 * self.scl_y, 40, self.skinColor, 0, -200, 0);
		self.leftLowerLegBack = createLimb(40, 200 * self.scl_y, 40, self.skinColor, 0, -200, 0+200);
		self.leftLeg = createLimb(50, 170 * self.scl_y, 50, self.shortsColor, -50, -10, 30);
		self.leftLegBack = createLimb(50, 170 * self.scl_y, 50, self.shortsColor, -50, -10, 30+200);
		self.rightLowerLeg = createLimb(40, 200 * self.scl_y, 40, self.skinColor, 0, -200, 0);
		self.rightLowerLegBack = createLimb(40, 200 * self.scl_y, 40, self.skinColor, 0, -200, 0+200);
		self.rightLeg = createLimb(50, 170 * self.scl_y, 50, self.shortsColor, 50, -10, 30);
		self.rightLegBack = createLimb(50, 170 * self.scl_y, 50, self.shortsColor, 50, -10, 30+200);
		self.element = createGroup(0, 0, -4000 - 4000);
		self.head = createGroup(0, 260, -15);
		self.head.add(self.face);
		self.head.add(self.hair);
		//self.leftArm.add(self.leftLowerArm);
		//self.rightArm.add(self.rightLowerArm);
