...
function World() {
	...
	function changeGray() {
		...
		else { element = document.getElementById('world1'); grayscale = true; }
		element.appendChild(renderer.domElement);
	}
...
function createBox(dx, dy, dz, color, x, y, z, gray) {
...
function createCylinder(radiusTop, radiusBottom, height, radialSegments, color, x, y, z,gray) {
...
function createBox_gray(dx, dy, dz, color, x, y, z, gray) {
    var geom = new THREE.BoxGeometry(dx, dy, dz);
    //var mat = new THREE.MeshPhongMaterial({
	//	color:color, 
    //	flatShading: notFlatShading != true
...
function createCylinder_gray(radiusTop, radiusBottom, height, radialSegments, color, x, y, z,gray) {
    var geom = new THREE.CylinderGeometry( radiusTop, radiusBottom, height, radialSegments);
    //var mat = new THREE.MeshPhongMaterial({ color: color, flatShading: true });
    var tmp = 0;
    if(gray == true) tmp = 0;
...
function loadCoinTexture(dx, dy, dz, color, x, y, z, notFlatShading){
	var geom = new THREE.BoxGeometry(dx, dy, dz);
	var loader = new THREE.TextureLoader();
    //var mat = new THREE.MeshPhongMaterial({
	//	color:color, 
...
function createCoin(radiusTop, radiusBottom, height, radialSegments, color, x, y, z){

	var geom = new THREE.CircleGeometry( radiusTop, 1100);
