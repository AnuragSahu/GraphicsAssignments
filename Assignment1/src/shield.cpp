...
#define wid 9
 ...
 Shield:: Shield(float x, float y,GLfloat scl, color_t color) {
    ...
    static GLfloat vertex_buffer_data1[] = {
      -2.0f*scl_x,  -2.0f*scl_y,  scl_z,    2.0f*scl_x,  2.0f*scl_y, scl_z, -2.0f*scl_x,  2.0f*scl_y, scl_z,
      -2.0f*scl_x,  -2.0f*scl_y,  scl_z,    2.0f*scl_x,  2.0f*scl_y, scl_z,  2.0f*scl_x, -2.0f*scl_y, scl_z,
    };  
    static GLfloat vertex_buffer_data2[] = {
      -1.0f*scl_x,  -1.0f*scl_y,  scl_z,    1.0f*scl_x,  1.0f*scl_y, scl_z, -1.0f*scl_x,  1.0f*scl_y, scl_z,
      -1.0f*scl_x,  -1.0f*scl_y,  scl_z,    1.0f*scl_x,  1.0f*scl_y, scl_z,  1.0f*scl_x, -1.0f*scl_y, scl_z,
    };  
    this->object1 = create3DObject(GL_TRIANGLES, 2*3, vertex_buffer_data1, color, GL_FILL);
    this->object2 = create3DObject(GL_TRIANGLES, 2*3, vertex_buffer_data2, {255,255,225}, GL_FILL);
}
